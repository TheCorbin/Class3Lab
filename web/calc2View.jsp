...
<html>
    ...
    <body>
        ...
        <p><% Object areaObject = request.getAttribute("area");
              String areaString = null;
              if(areaObject == null){
                  areaString = "Click calculate to see the area";
              } else {
                  areaString = "The area of your rectangle is: " + areaObject.toString();
              }
              
              out.print("<br>" + areaString);
            %>
        </p>
    </body>    
</html>
